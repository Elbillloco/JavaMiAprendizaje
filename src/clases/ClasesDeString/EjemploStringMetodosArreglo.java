...
public class EjemploStringMetodosArreglo {
    public static void main(String[] args) {
        ...
        System.out.println("1 trabalenguas.length() = " + trabalenguas.length());//aqui es un metodo de String
        System.out.println("2 trabalenguas = " + trabalenguas.toCharArray());/* .toCharArray convierte nuestro
        ...
        System.out.println("3 largo = " + largo);// imprime el largo
        ...
        System.out.println("4 trabalenguas = " + trabalenguas.split("a"));/*.split se utiliza para separar
        ...
        String archivo ="5 alguna.image.pdf";
        ...
        System.out.println("6 extension = " + archivoArr[l-1]);
    }
}
